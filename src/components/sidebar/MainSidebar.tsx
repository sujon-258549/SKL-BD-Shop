  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform bg-gradient-to-b from-cyan-800 to-cyan-950 dark:from-cyan-900 dark:to-cyan-800 ${
